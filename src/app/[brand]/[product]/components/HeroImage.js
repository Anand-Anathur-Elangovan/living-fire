  ...
  return (
    <>
      {!editMode && (<> <div className="hero-slider-container">
          ...
          {editMode && (<>
          <div style={{width:'50%', marginBottom:24, marginLeft: '54px'}}>
            <h4>Hero Images</h4>
              ...
              <div key={idx} style={{display:'flex',alignItems:'center',marginBottom:16,gap:8, flexWrap: 'wrap'}}>
                ...
                {img.value && (
                  <div style={{width: '100%', marginTop: 8}}>
                    <div style={{fontSize: 12, marginBottom: 4, color: '#666'}}>Preview:</div>
                    <div style={{border: '1px solid #ddd', borderRadius: 4, padding: 8, width: '100%', maxWidth: 300}}>
                      <Image
                        src={img.value !== "TBC" ? transformImageSrc(img.value) : ""}
                        alt="Preview"
                        width={200}
                        height={150}
          ...
          <div style={{display:'flex',gap:8,marginTop:8,justifyContent:'flex-start', marginLeft: '54px'}}>
