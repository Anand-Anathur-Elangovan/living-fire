...
const Featured = ({ headingValue, productRouteHandler }) => {
  ...
  return (
    <div className="flex relative justify-center flex-col gap-10 ml-0 mr-0 md:ml-16 md:mr-16">
      ...
      <div
        ref={carouselRef}
        className="grid grid-flow-col auto-cols-[100%] gap-5 overflow-x-auto overscroll-x-contain feature-snaps before:px-1 hide-scrollbar ml-8  md:auto-cols-[25%]"
      >
