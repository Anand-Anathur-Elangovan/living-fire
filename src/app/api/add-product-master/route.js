...
//     const brandQuery =
//       "SELECT brand_name, brand_desc FROM brands WHERE brand_id = $1";
...
//     if (fueltype_id) {
//       const fueltypeQuery =
//         "SELECT fueltype_name FROM fueltypes WHERE fueltype_id = $1";
...
//     if (targetTable) {
//       // Create dynamic insert query for the specific table
//       const insertQuery = `
