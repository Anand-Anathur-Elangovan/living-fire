...
export const metadata = {
  ...
  description:
    "Read the terms and conditions of Living Fire to understand our policies regarding purchases, warranties, and service agreements.",
  keywords:
    "Living Fire terms, terms and conditions, fireplace purchase policy, warranty terms, service terms, legal agreement",
  alternates: {
    canonical: "https://www.livingfire.com.au/terms",
  },
  robots: "index, follow",
  authors: [
    { name: "Living Fire Team", url: "https://livingfire.com.au" },
  ],
...
export default function Page() {
  ...
  “We”, “Us”, “Our or “Ourselves”” means Paul Agnew Designs P ty Ltd T/A Living Fire or PAD Fires, its successors and assigns or any person acting on behalf of and with the authority of Paul Agnew Designs Pty Ltd T/A Living Fire or PAD Fires. 
  ...
  accounts@livingfire.com.au
  Postal Address:  148-150 Cochranes Road
                                 Moorabbin VIC 3189
  ...
  You further acknowledge and agree that the filing of a claim against Us (if any) must be made in the State of VIC in which our principal business premises in Australia is domiciled, and that any legal proceedings will be conducted in English.
      ...
      <div className="privacy-policy-container">
        ...
        <div className="privacy-container">
          <div>
            <p>
              <b>
                The use of this Website is subject to these Terms and Conditions
                (inclusive of Our standard Terms and Conditions for the supply
                of Goods and Services, Privacy Policy, Refund Policy any other
                documents referred to herein) which constitutes the full
                agreement between You and Us. Please read these Terms and
                Conditions carefully before You use the Website. By using the
                Website, You indicate that You have, effective upon the date on
                which You have used the Website, read, accepted and agreed to be
                bound by these Terms and Conditions. If You do not agree with
                these Terms and Conditions, You should cease using the Website
                immediately.
              </b>
            </p>
            <br />
