...
//       label: 'Brands',
//       table: 'tbl_brands',
//       columns: ['brand_name', 'brand_logo_url', 'brand_desc', 'slug']
//     },
//     glass_orientation: {
...
//                 <tr key={item[`${activeTab.split('_')[0]}_id`]}>
//                   {currentConfig.columns.map(column => (
...
//                     <button
//                       onClick={() => handleDeactivate(item[`${activeTab.split('_')[0]}_id`])}
...
// components/ManageOthers.jsx - Update the main component
'use client';
import { useState, useEffect } from 'react';
import AddOthersForm from './AddOthersForm';
