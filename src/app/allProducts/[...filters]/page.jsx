...
const specialCombinationsMetaData = [
  ...
  },
  {
    ...
    description:
      "Discover the pinnacle of luxury with our wooden fireplace range, offering exquisite design and unmatched warmth for your home. Delivery across Australia.",
    keywords: [
      "wood fireplaces",
      "modern wooden fireplaces",
      "luxury wood heaters",
      "Australian made fireplaces",
    ],
  ...
  },
  {
    ...
    description:
      "Elevate your home ambiance with our durable cast iron wood stove. Efficient heating and classic design for cozy comfort. Explore our selection today!",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Elevate your home's ambiance with our exquisite free-standing wood fireplace. Timeless design meets warmth and elegance. Explore now!",
    keywords: [
      "freestanding wood fireplace",
      "standalone wood heater",
      "modern wood stove",
    ],
  ...
  },
  {
    ...
    title: "Double Sided Wood Fireplaces | Living Fire",
    description:
      "Explore double-sided wood fireplaces for a cozy ambiance. Stylish designs, efficient heating. Perfect for any home. Transform your space today!",
    keywords: [
      "double sided wood fireplace",
      "see through wood heater",
      "two sided wood burner",
    ],
    ogImage: "/og/two-sided-wood.jpg",
  },
  {
    ...
    description:
      "Experience warmth and style with our three-sided wood fireplace. Perfect for cozy gatherings, its elegant design enhances any living space.",
    keywords: [
      "three sided wood fireplace",
      "panoramic wood burner",
      "270 degree fireplace",
    ],
    ogImage: "/og/three-sided-wood.jpg",
  },
  {
  ...
  },
  {
    ...
    description:
      "Elevate your outdoor living with our stunning wood fireplaces. Embrace the warmth and charm of natural flames for unforgettable moments outdoors.",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Discover our range of modern gas fireplaces. Elevate your indoor space with efficient heating and a cosy, warm ambience with a luxury gas fireplace.",
    keywords: [
      "gas fireplaces",
      "modern gas heaters",
  ...
  },
  {
    ...
    description:
      "Elevate your living space with our stylish double-sided gas fireplace. Experience ultimate warmth and ambiance. Browse now!",
    keywords: [
      "double sided gas fireplace",
      "see through gas fire",
      "two sided gas heater",
    ],
  ...
  },
  {
    ...
    description:
      "Experience warmth and elegance with our three-sided gas fireplace. Perfect for modern spaces, enjoy panoramic views and efficient heating.",
    keywords: [
      "three sided gas fireplace",
      "270 degree gas fire",
      "panoramic gas heater",
    ],
  ...
  },
  {
    ...
    description:
      "Transform your space with our freestanding gas fireplaces. Sleek design, efficient heating, and easy installation. Explore our collection now!",
    keywords: [
      "freestanding gas fireplace",
      "standalone gas heater",
      "portable gas fire",
    ],
  ...
  },
  {
    ...
    description:
      "Discover the perfect centrepiece for your outdoor gatherings with our range of stylish and efficient gas fireplaces. Transform your outdoor space today!",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Elevate your space with our inbuilt gas fireplaces, combining modern design and efficient heating. Discover the perfect centerpiece for your home.",
    keywords: [
      "inbuilt gas fireplace",
      "built in gas heater",
      "custom gas fire design",
    ],
  ...
  },
  {
    ...
    description:
      "Discover our range of luxury indoor electric fireplaces - stylish and efficient, heating solutions. Visit our showrooms in Melbourne today!",
    keywords: [
      "electric fireplaces",
  ...
  },
  {
    ...
    keywords: [
      "Paul Agnew Designs",
      "luxury fireplace brands",
      "designer fireplaces Australia",
    ],
  ...
  },
  {
    ...
    keywords: [
      "Paul Agnew Pyro",
      "wood burning designer fireplace",
      "Pyro collection",
    ],
  ...
  },
  {
    ...
    keywords: [
      "Eurostove fireplaces",
      "European wood heaters",
      "quality fireplace brands",
    ],
  ...
  },
  {
    ...
    keywords: [
      "Austroflamm fireplaces",
      "Austrian wood heaters",
      "European quality stoves",
    ],
  ...
  },
  {
    ...
    description:
      "Living Fire is partnered with a range of premium fireplace brands including Morsø. Visit us online now for more information",
    keywords: [
      "Morsø fireplaces",
      "Danish design stoves",
      "scandinavian wood heaters",
    ],
  ...
  },
  {
    ...
    description: "",
    keywords: [
      "Heatmaster gas fires",
      "Australian gas heaters",
      "efficient gas log fires",
    ],
  ...
  },
  {
    ...
    description:
      "Living Fire is partnered with a range of premium fireplace brands including Hergóm. Visit us online now for more information",
    keywords: [
      "Hergóm fireplaces",
      "Spanish wood stoves",
      "European quality heaters",
    ],
  ...
  },
  {
    ...
    description:
      "Find the perfect bioethanol fireplace in our online store. Eco-friendly and stylish, they provide the perfect warmth for your home. Order online today.",
    keywords: [
      "bioethanol fireplaces",
      "eco friendly heaters",
      "flueless fire designs",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "wall mounted ethanol fire",
      "custom biofuel heater",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "portable ethanol heater",
      "standalone biofuel fire",
    ],
  ...
  },
  {
    ...
    description:
      "View Our Luxury Fireplace Mantel Range Online Now. For All Enquiries About Our Fireplace Mantels, Contact The Living Fire Australia Team Today.",
  ...
  },
  {
    ...
    description:
      "View Our Luxury Cast Iron Fireplace Range Online Now. For All Enquiries About Our Victorian Fireplace Products Contact Us Today.",
    keywords: [
      "cast iron fireplaces",
      "victorian style heaters",
      "classic wood stoves",
    ],
  ...
  },
  {
    ...
    description:
      "View Our Luxury Fireplace Accessories Range Online Now. For All Enquiries About Our Fireplace Products Contact The Living Fire Team Today",
    keywords: [
      "fireplace tools",
      "hearth accessories",
