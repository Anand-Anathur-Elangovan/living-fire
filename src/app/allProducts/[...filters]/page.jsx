...
export async function generateMetadata({ params }) {
  ...
  return {
      ...
      description: `Explore fireplaces with filters: ${filters.join(", ")} at Living Fire.`,
      keywords: filters.join(", "),
      alternates: {
          canonical: `https://living-fire.vercel.app/allProducts/${filters.map(encodeURIComponent).join("/")}`,
      },
      robots: "index, follow",
  };
}
